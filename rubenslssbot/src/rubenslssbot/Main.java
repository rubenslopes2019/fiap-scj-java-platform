	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			for (Update update : updates) {
				...
				pergunta.add("quero");
				pergunta.add("gostaria");
				pergunta.add("preciso");
				pergunta.add("operacao");
				pergunta.add("conta");	
				pergunta.add("dinheiro");
				pergunta.add("corrente");
				pergunta.add("poupanca");
				pergunta.add("grana");
				pergunta.add("opcao");
				pergunta.add("menu");
				...
				while(palavras.hasMoreTokens()) {
					...
					if ((palavra.indexOf("corren") >= 0) || palavra.contains("cc") || palavra.contains("c/c")) {
						if (opcaoEscolhida == 1) {
					...
					if ((palavra.indexOf("poupa") >= 0) || palavra.contains("cp") || palavra.contains("c/p")) {
						if (opcaoEscolhida == 1) {
					...
					if (operacao != "") {
						...
						try {
							valorDouble = (Double.parseDouble(palavra));
							ehNumero = true;
						} catch (NumberFormatException e) {
							ehNumero = false;
						}
